<script lang="ts">
  ...
  import { TargetAppTypeDataSheetWidget, TargetAppTypeDataTableWidget, TargetAppTypeUserGroupApp } from "../target";
  ...
  let mode: "pick_source" | "pick_group" | "pick_sheet" | "pick_plug" | "pick_agent" =
    "pick_source";
