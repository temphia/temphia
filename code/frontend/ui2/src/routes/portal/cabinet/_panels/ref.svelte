...
<div class="p-2 ">
    ...
    <!-- vertical tabs -->
    <div class="flex flex-wrap flex-row p-4 bg-white rounded">


      <div class="flex-shrink max-w-full px-4 w-full">
        <div  class="relative">
          <h3 class="text-lg font-semibold text-gray-600 dark:text-gray-200 mb-3">Quick Filter</h3>
          <!-- filter start -->
          <div class="inline-block mb-6">
            <a href="javascript:;" class="inline-block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-900 shadow rounded text-center ltr:mr-2 rtl:ml-2 mb-2 bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
            ...
            <a href="javascript:;"  class="inline-block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-900 shadow rounded text-center ltr:mr-2 rtl:ml-2 mb-2">
