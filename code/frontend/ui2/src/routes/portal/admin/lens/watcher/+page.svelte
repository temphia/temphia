<div class="h-full p-2">
    <div class="card h-full">
        <div class="card-header">
            <h3 class="h3 underline">Sockd Room Watcher</h3>
        </div>

        <div
            class="p-4 overflow-y-auto main-outter"
            style="height: calc(-10rem + 100%);"
        >
            ...
            <div class="mb-2">
                ...
                >
                    This is a response from the room.
                </p>
            </div>
            <div class="mb-2 text-right">
                <p
        ...
        <div class="h-20 p-4 border-t flex">
            <input
                id="user-input"
                type="text"
