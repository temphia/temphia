...
func (d *DynDDL) NewGroup(tenantId string, model *bprints.NewTableGroup) error {
...
func (d *DynDDL) newGroupRef(tenantId string, model *bprints.NewTableGroup) (err error) {
