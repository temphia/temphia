...
type UserOps interface {
	...
	UpdateUserData(tenantId, slug string, data map[string]interface{}) error
}
...
type AgentOps interface {
	...
	AgentLinkUpdate(tenantId, pid, aid string, id int64, data map[string]interface{}) error
	...
	AgentExtensionUpdate(tenantId, pid, aid string, id int64, data map[string]interface{}) error
	...
	AgentResourceUpdate(tenantId, pid, aid, slug string, data map[string]interface{}) error
...
type RepoOps interface {
	...
	RepoUpdate(tenantId string, id int64, data map[string]interface{}) error
