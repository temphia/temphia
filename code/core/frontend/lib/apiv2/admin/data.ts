...
export class DataAPI {
  ...
  list_group(source: string) {
    return this.base.get(`/admin/data/${source}`);
  }

  new_group(source: string, data: any) {
    return this.base.post(`/admin/data/${source}`, data);
  }
  ...
  list_tables(source: string, gid: string) {
    return this.base.get(`/admin/data/${source}/${gid}/table`);
  }

  add_table(source: string, data: any, gid: string) {
    return this.base.post(`/admin/data/${source}/${gid}/table`, data);
  }

  get_table(source: string, gid: string, tid: string) {
    return this.base.get(`/admin/data/${source}/${gid}/table/${tid}`);
  }

  edit_table(source: string, gid: string, tid: string, data: any) {
    return this.base.post(`/admin/data/${source}/${gid}/table/${tid}`, data);
  }

  delete_table(source: string, gid: string, tid: string) {
    return this.base.delete(`/admin/data/${source}/${gid}/table/${tid}`);
  }

  // column

  list_column(source: string, gid: string, tid: string) {
    return this.base.get(`/admin/data/${source}/${gid}/table/${tid}/column`);
  }
  ...
  list_view(source: string, gid: string, tid: string) {
    return this.base.get(`/admin/data/${source}/${gid}/table/${tid}/view`);
  }
