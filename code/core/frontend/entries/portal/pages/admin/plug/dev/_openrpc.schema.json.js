export default {
  ...
  "properties": {
    "openrpc": {
      ...
      "type": "string",
      "enum": [
        "GENERATED FIELD: Do Not Edit - if you are seeing this unexpectedly, use released meta-schema (https://github.com/open-rpc/meta-schema/releases)"
      ]
    },
    "info": {
    ...
    "methodObject": {
      ...
      "properties": {
        ...
        "paramStructure": {
          ...
          "enum": ["by-position", "by-name", "either"],
          "default": "either"
        },
        "params": {
