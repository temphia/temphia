<script lang="ts">
  ...
  import { ActionAddButton } from "../../../../_shared/common";
  ...
  const load = async () => {
    ...
    const resp1 = tapi.get_tenant();
    const resp2 = tapi.list_tenant_domain();
      ...
      >
        ...
        {#if loaded}
          <div class="absolute right-0 p-2">
            <button
              on:click={() => app.navigator.goto_admin_org_edit(tenant)}
          ...
          <div class="flex-col flex py-3 relative border rounded p-2">
            <div class="absolute right-1">
              <ActionAddButton onClick={app.navigator.goto_admin_domain_new} />
            </div>
            ...
            <AutoTable
              ...
              actions={[
                {
                  Name: "Edit",
                  Action: app.navigator.goto_admin_domain_edit,
                  icon: "pencil",
                },
                {
                  Name: "Widgets",
                  Action: app.navigator.goto_admin_widgets,
                  icon: "puzzle",
                },
                {
                  Name: "Delete",
